...
export const productFormSchema = z.object({
  ...
  stock: z.coerce.number().min(0, {message: "El stock debe ser mayor a 0"}).max(1000000, {message: "El stock debe ser menor a 1000000"}),
  ...
  fechaIngresado: z.coerce.date().optional(),
})
